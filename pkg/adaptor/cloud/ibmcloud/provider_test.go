	...
	tests := []struct {
		...
		},
		{
			...
			provider: &ibmcloudVPCProvider{
				...
				serviceConfig: &Config{
					Images:                  validImageList,
					InstanceProfileSpecList: []cloud.InstanceTypeSpec{cloud.InstanceTypeSpec{InstanceType: "bz2-2x8", Arch: "s390x"}},
				},
			},
			instanceSpec:    cloud.InstanceTypeSpec{},
			expectListErr:   false,
		...
		// Test selecting an image from an image list with no valid archs because of profile instance arch difference
		{
			...
			provider: &ibmcloudVPCProvider{
				...
				serviceConfig: &Config{
					Images:                  validImageList,
					InstanceProfileSpecList: []cloud.InstanceTypeSpec{cloud.InstanceTypeSpec{InstanceType: "bx2-2x8", Arch: "amd64"}},
				},
			},
			instanceSpec:    cloud.InstanceTypeSpec{},
			expectListErr:   false,
